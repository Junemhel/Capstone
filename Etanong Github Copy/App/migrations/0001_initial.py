# Generated by Django 3.2.7 on 2022-09-28 07:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Quiz',
            fields=[
                ('quiID', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('answerThree', models.CharField(blank=True, max_length=300)),
                ('answerFour', models.CharField(blank=True, max_length=300)),
            ],
        ),
        migrations.CreateModel(
            name='User',
